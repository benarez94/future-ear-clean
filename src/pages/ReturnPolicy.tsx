...
const ReturnPolicy = () => {
  ...
  return (
    ...
    >
      ...
      <div className="py-20 pt-32 max-w-4xl mx-auto px-4" ref={topRef}>
        ...
        <ScrollArea className="h-96 w-full rounded-md border p-4 mb-8">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="section-1">
              <AccordionTrigger onClick={scrollToTop}>1. Délai de rétractation</AccordionTrigger>
              <AccordionContent>
                Vous disposez d'un délai de 30 jours à compter de la réception de votre produit pour exercer votre droit de rétractation, 
                sans avoir à justifier de motifs ni à payer de pénalités (à l'exception des frais de retour).
              </AccordionContent>
            </AccordionItem>
            
            <AccordionItem value="section-2">
              <AccordionTrigger onClick={scrollToTop}>2. Conditions de retour</AccordionTrigger>
              <AccordionContent>
                <p>Pour être éligible à un retour, votre article doit être :</p>
            ...
            <AccordionItem value="section-3">
              <AccordionTrigger onClick={scrollToTop}>3. Procédure de retour</AccordionTrigger>
              <AccordionContent>
                <p>Pour retourner un produit, veuillez suivre ces étapes :</p>
            ...
            <AccordionItem value="section-4">
              <AccordionTrigger onClick={scrollToTop}>4. Remboursements</AccordionTrigger>
              <AccordionContent>
                <p>
            ...
            <AccordionItem value="section-5">
              <AccordionTrigger onClick={scrollToTop}>5. Produits défectueux</AccordionTrigger>
              <AccordionContent>
                <p>
            ...
            <AccordionItem value="section-6">
              <AccordionTrigger onClick={scrollToTop}>6. Contact</AccordionTrigger>
              <AccordionContent>
                <p>
